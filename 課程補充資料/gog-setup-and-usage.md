...
gog drive search "*" --max 5 --account jacky02@gmail.com
```
...
- 私人 / AI 測試：`jacky01@gmail.com`
- 主要個人：`jack02@gmail.com`
- 其他用途：`jacky03@gmail.com`

實務建議：

- **排私人行程** → 用 `jacky01` 的 calendar
- **排工作 / 對外會議** → 用 `jack02` 的 calendar
- **測試寄信 / 自動化實驗** → 用 `jacky03`
